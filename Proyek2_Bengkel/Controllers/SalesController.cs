...
namespace Proyek2_Bengkel.Controllers
{
    public class SalesController : Controller
    {
        ...
        {
            var proyek2_BengkelContext = _context.Sale.Include(s => s.Customer).Include(s => s.Teller);
        ...
        public async Task<IActionResult> Create([Bind("Id,TellerId,CustomerId,Description,TotalCost,SaleDate")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TellerId,CustomerId,Description,TotalCost,SaleDate")] Sale sale)
        {
            if (id != sale.Id)
            {
                return NotFound();
